        ...
        <ProjectBoxV2
          ...
          accordionPanelRender={() => (
            <Flex flexDir="column" px="30px" pb="30px">
              <OrderedList>
                <ListItem>
                  <b>Decentralization & Transparency:</b> Real-time, verifiable
                  information is available, with a focus on on-chain activities,
                  which eliminates the need for audits and reduces operational
                  costs.
                </ListItem>
                <ListItem>
                  <b>Asset Control & Innovation:</b> The DAO emphasizes
                  self-custody, allowing members to retain direct control over
                  their assets. This model fosters innovation by utilizing smart
                  contracts and decentralized applications (dApps) to automate
                  processes and develop efficient investment products.
                </ListItem>
              </OrderedList>
            </Flex>
          )}
        ...
        <ProjectBoxV2
          ...
          accordionPanelRender={() => (
            <Flex flexDir="column" px="30px" pb="30px">
              ...
              <Text>
                Enzyme Finance&lsquo;s focus on security and transparency allows
                investors to monitor their funds&lsquo; performance and validate
                fund managers&lsquo; actions in real-time through
          ...
          accordionPanelRender={() => (
            <VStack px="30px" flexDir="column" spacing={30}>
              ...
              <Text>
                ...
                our security measures, we provide our fund members with a secure
                and trustworthy investment environment.
              </Text>
            </VStack>
          )}
          imagesSrc={[
